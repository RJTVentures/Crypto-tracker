...
v3.1  —  Local self-hosted crypto portfolio tracker and market scanner
...
Get a free key at coingecko.com/en/developers. Recommended if you use the scanner frequently.
Auto-Start on Boot (macOS LaunchAgent)
Create ~/Library/LaunchAgents/com.rjtventures.cryptotracker.plist with your username substituted in the paths, then run:
...
Notes
•	The server runs locally and is only accessible on your home network. Not intended to be exposed to the internet.
